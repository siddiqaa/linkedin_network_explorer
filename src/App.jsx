            ...
            {visible.map((r, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ padding: "9px 12px", color: C.textDim, maxWidth: 200, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{r["Position"]}</td>
...
export default function App() {
  ...
  const loadSample = () => setData(generateSample());
